...
namespace FleetOps.Order.Tests.Application.OrdersTests.CommandsTests.MarkOrderAsPickedUpTests;

public class MarkOrderAsPickedUpCommandHandlerTests
{
    private readonly Mock<IOrderRepository> _orderRepositoryMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly MarkOrderAsPickedUpCommandHandler _handler;

    public MarkOrderAsPickedUpCommandHandlerTests()
    {
        _orderRepositoryMock = new Mock<IOrderRepository>();
        _unitOfWorkMock = new Mock<IUnitOfWork>();

        _handler = new MarkOrderAsPickedUpCommandHandler(
            _unitOfWorkMock.Object,
            _orderRepositoryMock.Object);
    }

    [Fact]
    public async Task Handle_WhenOrderIsDriverAccepted_ShouldMarkOrderAsPickedUp()
    {
        // Arrange
    ...
    public async Task Handle_WhenDriverIdIsEmpty_ShouldReturnFailureWithoutSaving()
    {
        ...
        var order = CreateDriverAcceptedOrder(assignedDriverId);
    ...
    [Fact]
    public async Task Handle_WhenOrderIsNotDriverAccepted_ShouldReturnFailureWithoutSaving()
    {
        // Arrange
        var driverId = Guid.NewGuid();
